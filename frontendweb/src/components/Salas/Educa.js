...
const Educa = () => {
  ...
  const fetchProyectores = async () => {
    try {
      ...
      // Filtrar solo los proyectores de la Sala 5 Educa
      const proyectoresSala1 = data.filter((item) => item.sala === 5)
  ...
  const fetchInteractivos = async () => {
    try {
      ...
      const data = await response.json()
      // Filtrar solo los interactivos de la Sala 5 Educa
      const interactivosSala1 = data.filter((item) => item.sala === 5)
      ...
      <div className="container">
        ...
        >
          <div className="text-center">
            ...
            <h4 className="mt-3 text-muted">Cargando equipos de la Sala Educa...</h4>
          </div>
        </div>
      </div>
    )
                ...
                <div className="d-flex align-items-center justify-content-between">
                  <div>
                    ...
                    <p className="mb-0 opacity-90 text-white">
                      Visualiza y administra todos los equipos de la Sala Educa
                    </p>
                  </div>
              ...
              <Col className="text-center">
                <div className="py-5">
                  ...
                  <h4 className="text-muted mt-3">
                    {equiposCombinados.length === 0 ? "No hay equipos en la Sala Educa" : "No se encontraron equipos"}
                  </h4>
                  <p className="text-muted">
                    {equiposCombinados.length === 0
                      ? "No se encontraron equipos registrados para la Sala Educa"
              ...
              <Col md={8}>
                ...
                <Row className="g-3">
                  ...
                  <Col sm={6}>
                    <strong>Sala:</strong>
                    <br />
                    <span className="text-muted">Sala Educa(ID: {equipoSeleccionado.sala})</span>
                  </Col>
