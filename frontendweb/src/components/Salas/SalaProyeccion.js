...
const SalaProyeccion = () => {
  ...
  const fetchProyectores = async () => {
    try {
      ...
      // Filtrar solo los proyectores de la Sala 7 Proyeccion
      const proyectoresSala1 = data.filter((item) => item.sala === 7)
  ...
  const fetchInteractivos = async () => {
    try {
      ...
      const data = await response.json()
      // Filtrar solo los interactivos de la Sala 7 Proyeccion
      const interactivosSala1 = data.filter((item) => item.sala === 7)
      ...
      <div className="container">
        ...
        >
          <div className="text-center">
            ...
            <h4 className="mt-3 text-muted">Cargando equipos de la Sala de Proyeccion...</h4>
          </div>
        </div>
      </div>
    )
                ...
                <div className="d-flex align-items-center justify-content-between">
                  <div>
                    <h1 className="h2 mb-2 fw-bold text-white">
                      ...
                      Equipos - Sala de Proyeccion
                    </h1>
                    <p className="mb-0 opacity-90 text-white">
                      Visualiza y administra todos los equipos de la Sala de Proyeccion
                    </p>
                  </div>
              ...
              <Col className="text-center">
                <div className="py-5">
                  ...
                  <h4 className="text-muted mt-3">
                    {equiposCombinados.length === 0 ? "No hay equipos en la Sala de Proyeccion" : "No se encontraron equipos"}
                  </h4>
                  <p className="text-muted">
                    {equiposCombinados.length === 0
                      ? "No se encontraron equipos registrados para la Sala de Proyeccion"
              ...
              <Col md={8}>
                ...
                <Row className="g-3">
                  ...
                  <Col sm={6}>
                    <strong>Sala:</strong>
                    <br />
                    <span className="text-muted">Sala de Proyeccion(ID: {equipoSeleccionado.sala})</span>
                  </Col>
